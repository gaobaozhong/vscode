...
def handwritingClassTest():
    hwLabels = []
    trainingFileList = listdir(r'C:\Users\gao\Documents\code\python\digits\trainingDigits')
    ...
    for i in range(m):
        ...
        trainingMat[i,:]=img2vector('C:\Users\gao\Documents\code\python\digits\trainingDigits\%s'%fileNameStr)
    testFileList = listdir(r'C:\Users\gao\Documents\code\python\digits\trainingDigits')
    errorCount = 0.0
